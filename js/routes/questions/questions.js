...
var { BEFORE_SUBMIT, DISCLAIMER } = require('../../config');
...
function askQuestions( slider ) {
    ...
    return new Promise( resolve => {
        ...
        function setTranslatedText( $element, obj ) {
            
            $element.html( translate( obj ) );
        ...
        function ask () {
            ...
            setTranslatedText( $question, q.question );
            setTranslatedText( $leftAnswer, q.left.answer );
            setTranslatedText( $rightAnswer, q.right.answer );
            ...
            awaitButton()
                ...
                .then(() => {
                    ...
                    if ( currQuestion <= questions.length - 1 ) {
                        ...
                        $question.html(`
                            <p>${ translate( BEFORE_SUBMIT ) }</p>
                            <p class="small">${ translate( DISCLAIMER ) }</p>
                        `);
